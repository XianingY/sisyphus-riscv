...
struct SelfOptStats {
  ...
  int polyMatrixNests = 0;
  int polyDepDirections = 0;
  int polyPermutations = 0;
  int polyTiles = 0;
  int matrixRegisterTiles = 0;
  int tileInsertFixes = 0;
...
void repairAffineYieldTerminators(Module &module, SelfOptStats *stats = nullptr);
